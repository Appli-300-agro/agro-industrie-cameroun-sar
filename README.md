# Agro Industrie Cameroun Sar - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Agro Industrie Cameroun Sar**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@agroindustriecamerounsar.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@agroindustriecamerounsar.cm` | `user123` | |
...
*   **Contact :** contact@agroindustriecamerounsar.cm